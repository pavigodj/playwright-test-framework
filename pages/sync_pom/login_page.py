...
class LoginPage:
    def __init__(self, page: sync_page):
        self.page = page
    ...
    def is_cant_login_modal(self):
        self.page.get_by_role("link", name="Can't log in?").click()
        return self.page.locator(HomepageLocators.modal_pop_up).is_visible()
